  ...
  return (
    <main className="bg-black text-white relative flex items-center justify-center h-screen">
      <motion.div
        ...
        className="absolute top-2 transform flex justify-center gap-10 z-10"
      >
        <ButtonNeon 
          href='/promos'
      ...
      <motion.div
        ...
        className="relative z-10 text-center max-w-2xl bg-black bg-opacity-70 p-8 rounded-xl mt-20"
      >
        <motion.h1
